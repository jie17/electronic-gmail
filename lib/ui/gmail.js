...
function Gmail() {
  ...
  console.info(jQuery('.T-I.J-J5-Ji.nu.T-I-ax7.L3'));
...
Gmail.prototype.refresh = function(){
  console.log(jQuery('.T-I.J-J5-Ji.nu.T-I-ax7.L3'));
  jQuery('.T-I.J-J5-Ji.nu.T-I-ax7.L3')[0].click();
}
